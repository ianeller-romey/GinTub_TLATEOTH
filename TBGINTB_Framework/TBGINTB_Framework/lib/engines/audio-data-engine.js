(function (namespace, undefined) {
    ...
    namespace.Engines.AudioDataEngine = {
        init: function (audioElemId, messengerEngine) {
            ...
            var buildAudioUseDefinitions = function (data) {
                ...
                messengerEngine.post("AudioDataEngine.buildAudioUseDefinitions", audioUseDefinitions);
            };
            ...
            var loadEngine = function () {
                if (initSupportedFormat()) {
                    ...
                    messengerEngine.post("AudioDataEngine.getAllAudio", supportedFormat.ext);
                }
            };
